...
#define SC223A_SUPPORT_100FPS_SCLK (79200000)
...
struct tx_isp_sensor_attribute sc223a_attr={
	...
	.max_integration_time_native = 1200 - 4,
	.integration_time_limit = 1200 - 4,
	.total_width = 2250,
	.total_height = 1200,
	.max_integration_time = 1200 - 4,
...
static struct regval_list sc223a_init_regs_640_360_100fps_mipi[] = {
    {0x0100, 0x00},
    {0x36e9, 0x80},
    {0x37f9, 0x80},
    {0x301f, 0x2a},
...
static struct tx_isp_sensor_win_setting sc223a_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= sc223a_init_regs_640_360_100fps_mipi,
	},
};
...
static int sc223a_set_fps(struct tx_isp_subdev *sd, int fps)
{
    ...
    case TX_SENSOR_MAX_FPS_100:
	    sclk = SC223A_SUPPORT_100FPS_SCLK;
        break;
    }
...
static int sc223a_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	case TX_SENSOR_MAX_FPS_30:
        ...
        sc223a_attr.mipi.clk = 405;
        sc223a_attr.mipi.settle_time_apative_en = 1;
		break;
	case TX_SENSOR_MAX_FPS_100:
		wsize = &sc223a_win_sizes[1];
        sc223a_attr.mipi.image_twidth = 640;
        sc223a_attr.mipi.image_theight = 360;
        sc223a_attr.mipi.clk = 198;
        sc223a_attr.mipi.settle_time_apative_en = 0;
		sc223a_attr.max_integration_time_native = 0x18c - 4;
		sc223a_attr.integration_time_limit = 0x18c - 4;
		sc223a_attr.total_width = 0x7d0;
		sc223a_attr.total_height = 0x18c;
		sc223a_attr.max_integration_time = 0x18c - 4;
		sc223a_attr.mipi.mipi_sc.sensor_csi_fmt = TX_SENSOR_RAW10;
		break;
	default:
