...
#define OS05A10_SUPPORT_SCLK_FPS_60 (95110560)
...
static struct regval_list os05a10_init_regs_2448_1776_15fps[] = {
        {0x0100, 0x00},
        {0x0001, 0xf2},
        {0x0103, 0x01},
        {0x0303, 0x01},
...
static struct regval_list os05a10_init_regs_2544_1888_15fps_test[] = {
    {0x0100, 0x00},
    {0x0103, 0x01},
    {0x0303, 0x01},
    {0x0305, 0x3c},
...
static struct regval_list os05a10_init_regs_1224_888_60fps[] = {
    /*@@ 7 7001 Res 1224x888 2lane MIPI960Mbps Linear12 60fps MCLK24M*/
    {0x0100, 0x00},
    {0x0103, 0x01},
    {0x0303, 0x01},
    {0x0305, 0x3c},
...
static struct tx_isp_sensor_win_setting os05a10_win_sizes[] = {
	...
	/* [5] 4M @15fps*/
	{
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= os05a10_init_regs_2448_1776_15fps,
	},
	/* [6] 1M @60fps*/
	{
		.width		= 1224,
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR12_1X12,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= os05a10_init_regs_1224_888_60fps,
	},
	/* [7] 4.8M @15fps*/
	{
		.width		= 2544,
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= os05a10_init_regs_2544_1888_15fps_test,
	},
	/* [8] 4.8M @15fps*/
	{
		.width		= 2544,
	...
	if(data_type == TX_SENSOR_DATA_TYPE_LINEAR){
		...
		case TX_SENSOR_MAX_FPS_15:
		        if(sensor_resolution == SENSOR_RES_400)
                            sclk = OS05A10_SUPPORT_SCLK_RES_400_FPS_15;
                        else if(sensor_resolution == SENSOR_RES_500)
                            sclk = OS05A10_SUPPORT_SCLK_FPS_15;
                        else if(sensor_resolution == SENSOR_RES_480)
                            sclk = OS05A10_SUPPORT_SCLK_RES_480_FPS_15;
		...
		case TX_SENSOR_MAX_FPS_60:
			sclk = OS05A10_SUPPORT_SCLK_FPS_60;
	...
	if(data_type == TX_SENSOR_DATA_TYPE_LINEAR){
		...
		case TX_SENSOR_MAX_FPS_15:
			    ...
			    wsize = &os05a10_win_sizes[5];
                            os05a10_attr.mipi.image_twidth=2448;
                            os05a10_attr.mipi.image_theight=1760;
			    os05a10_attr.max_integration_time_native = 0x9c4 - 8;
			    os05a10_attr.integration_time_limit = 0x9c4 - 8;
			    os05a10_attr.total_width = 0x9c0;
			    os05a10_attr.total_height = 0x9c4;
			    os05a10_attr.max_integration_time = 0x9c4 - 8;
			    os05a10_attr.mipi.mipi_sc.sensor_csi_fmt = TX_SENSOR_RAW10;
                        }else if(sensor_resolution == SENSOR_RES_480){
			    wsize = &os05a10_win_sizes[8];
                            os05a10_attr.mipi.image_twidth=2544;
                            os05a10_attr.mipi.image_theight=1888;
			    os05a10_attr.max_integration_time_native = 0x1240 - 8;
			    os05a10_attr.integration_time_limit = 0x1240 - 8;
			    os05a10_attr.total_width = 0x600;
			    os05a10_attr.total_height = 0x1240;
			    os05a10_attr.max_integration_time = 0x1240 - 8;
			    os05a10_attr.mipi.mipi_sc.sensor_csi_fmt = TX_SENSOR_RAW10;
                        }
			break;
		case TX_SENSOR_MAX_FPS_25:
		...
		case TX_SENSOR_MAX_FPS_60:
			wsize = &os05a10_win_sizes[6];
                        os05a10_attr.mipi.image_twidth=1224;
                        os05a10_attr.mipi.image_theight=888;
			os05a10_attr.max_integration_time_native = 0x606 - 8;
			os05a10_attr.integration_time_limit = 0x606 - 8;
			os05a10_attr.total_width = 0x404;
			os05a10_attr.total_height = 0x606;
			os05a10_attr.max_integration_time = 0x606 - 8;
			os05a10_attr.mipi.mipi_sc.sensor_csi_fmt = TX_SENSOR_RAW12;
			break;
		case TX_SENSOR_MAX_FPS_100:
			wsize = &os05a10_win_sizes[9];
