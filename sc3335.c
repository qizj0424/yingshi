...
#define sc3335_SUPPORT_30FPS_SCLK (108000000)
...
static int sensor_max_fps = TX_SENSOR_MAX_FPS_100;
...
struct tx_isp_sensor_attribute sc3335_attr={
	...
	.max_integration_time_native = 2*1400 - 10,
	.integration_time_limit = 2*1400 - 10,
	.total_width = 2500,
	.total_height = 1400,
	.max_integration_time = 2*1400 - 10,
...
static int sc3335_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	case TX_SENSOR_MAX_FPS_100:
		...
		sc3335_attr.max_integration_time_native = 2*408 - 10;
		sc3335_attr.integration_time_limit = 2*408 - 10;
		sc3335_attr.total_width = 2500;
		sc3335_attr.total_height = 408;
		sc3335_attr.max_integration_time = 2*408 - 10;
		memcpy((void*)(&(sc3335_attr.mipi)),(void*)(&sc3335_mipi),sizeof(sc3335_mipi));
		break;
	default:
		ISP_ERROR("do not support max framerate %d in mipi mode\n",sensor_max_fps);
